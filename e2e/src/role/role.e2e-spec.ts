...
import { RoleListPage } from './role-list.po';
import { SidenavPage } from '../sidenav.po';
import { RoleDetailPage } from './role-detail.po';
import { RoleDeletePage } from './role-delete.po';

describe('Role tests', () => {
  let headerPage: HeaderPage;
  let loginPage: LoginPage;
  let sidenavPage: SidenavPage;
  let listPage: RoleListPage;
  let detailPage: RoleDetailPage;
  let deletePage: RoleDeletePage;
  ...
  beforeEach(() => {
    headerPage = new HeaderPage();
    sidenavPage = new SidenavPage();
    listPage = new RoleListPage();
    detailPage = new RoleDetailPage();
    deletePage = new RoleDeletePage();
  });

  beforeEach(async () => {
    await waitAndClick(headerPage.appMenu);
    await waitAndClick(sidenavPage.roleMenu);
  });
  ...
  it('should display the roles list page', async () => {
    expect(await listPage.getPageTitleText()).toEqual('Roles');
  ...
  it('should create a new role', async () => {
    ...
    expect(await detailPage.pageTitle.getText()).toEqual('Role');
  ...
  it('should confirmation a role', async () => {
    ...
    expect(await deletePage.title.getText()).toEqual('Delete role');
